...
export const CartSlice = createSlice({
  ...
  selectors: {
    ...
    selectPlants: (state) => state.items.reduce((acc, item) => {
      if (!acc.includes(item.name)) acc.push(item.name);
      return acc;
    }, []),
  },
});
...
export const { selectItemCount, selectPlants } = CartSlice.selectors;
